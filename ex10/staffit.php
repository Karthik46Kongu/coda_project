...
if(mysqli_num_rows($result)>0)
{
	...
	{
		echo "<tr><td>".$row["name"]."</td><td>".$row["rollno"]."</td><td>".$row["gender"]."</td><td>".$row["branch"]."</td><td>".$row["hostel"]."</td><td>".$row["room"]."</td><td>".$row["email"]."</td><td>".$row["type"]."</td></tr><tr><td id='none'>";
		?>
